from bodhiext.sentence_transformers import SentenceTransformerEmbedder


def test_call_returns_the_answer_to_life():
    llm = SentenceTransformerEmbedder(model="Deep Thought", api_key="multiply-6-by-9", temperature=0.9)
